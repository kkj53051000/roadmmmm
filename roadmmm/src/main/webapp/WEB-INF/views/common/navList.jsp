	...
	<div class="navList">
		<div class = "list_bar">
			<div class="list-group">
			  <a href="/gllist?sector=STOCK" class="list-group-item list-group-item-action">가이드라인</a>
			  <a href="/sslist?sector=ALL" class="list-group-item list-group-item-action">주식 공부</a>
			  <a href="/ppllist?sector=LIVE" class="list-group-item list-group-item-action">인기게시글</a>
